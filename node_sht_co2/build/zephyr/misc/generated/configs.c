...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_USE_COMPENSATION, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 16365);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SENSIRION_SHT4X_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SOC_NV_FLASH_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_WINSEN_MHZ19B_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_TX_PWR_PLUS_4, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_TX_PWR_DBM, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_DATA_LEN_MAX, 128);
