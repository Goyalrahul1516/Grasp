...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 8193);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PERIODIC_SYNC_BUFFER_COUNT, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PER_ADV_SYNC_MAX, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_EXT_SCAN_BUF_SIZE, 1650);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PER_ADV_SYNC_BUF_SIZE, 1650);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_MAX_FDS, 6);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_KEY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_MUTEX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX_PTHREAD_MUTEX_COUNT, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_SIGNAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_RTSIG_MAX, 31);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_SIGNAL_STRING_DESC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_SPINLOCK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_UNAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_UNAME_VERSION_LEN, 60);
